...
template<typename T>
void cnpy::npz_save(std::string zipname, std::string fname, const T* data, const std::vector<size_t>& shape, std::string mode)
{
...
template void cnpy::npz_save<float>(std::string zipname, std::string fname, const float* data, const std::vector<size_t>& shape, std::string mode);
template void cnpy::npz_save<double>(std::string zipname, std::string fname, const double* data, const std::vector<size_t>& shape, std::string mode);
